...
namespace test
{
  public partial class Form1 : GLForm
  {
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
      ...
      IntPtr pfd = m_wgl.CreatePixelFormatDescriptor(WGL.PFD_FLAGS.DOUBLEBUFFER | WGL.PFD_FLAGS.DRAW_TO_WINDOW | WGL.PFD_FLAGS.SUPPORT_OPENGL, 0, 16, 16);

      Int32 pf = m_wgl.ChoosePixelFormat(hdc, pfd);
      if(pf == 0) throw new Exception("ChoosePixelFormat failed");

      Int32 spf = m_wgl.SetPixelFormat(hdc, pf, pfd);
